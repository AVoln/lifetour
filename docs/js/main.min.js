...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // ---------------------------------
  (0, _videoPlayer.play)();
  (0, _audioPlayer.playAudio)();
  (0, _initSwiper.initHeroSwiper)();
  (0, _initSwiper.initToursSwiper)();
  (0, _initSwiper.initTrainingSwiper)();
  (0, _initSwiper.initReviewsSwiper)();
  (0, _initSwiper.initGallerySwiper)();
  (0, _initSwiper.initAdvantagesSwiper)();
...
},{"./modules/audio-player":2,"./modules/form-validate/form":4,"./modules/init-swiper":10,"./modules/modals/init-modals":11,"./modules/video-player":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
var playAudio = function playAudio() {
  var audio = document.querySelector('[data-id="audio"]');
...
exports.initTrainingSwiper = exports.initToursSwiper = exports.initReviewsSwiper = exports.initHeroSwiper = exports.initGallerySwiper = exports.initAdvantagesSwiper = void 0;
var heroSwiper = document.querySelector('.hero__intro-swiper');
var toursSwiper = document.querySelector('.tours__swiper');
var trainingSwiper = document.querySelector('.training__swiper');
var reviewsSwiper = document.querySelector('.reviews__swiper');
var gallerySwiper = document.querySelector('.gallery__swiper');
var advantagesSwiper = document.querySelector('.advantages__swiper');
